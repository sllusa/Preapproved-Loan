...
1. Seed the fixtures: a live-offer customer (Marta), a verification-fail customer routed to human
   (Andrés), a senior accessibility/resume case (Rosa), a no-operable-account case, and an
   expired-offer case.
